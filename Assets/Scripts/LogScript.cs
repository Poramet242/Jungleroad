...
public class LogScript : MonoBehaviour, IGameWorldUpdatable
{
    ...
    private void Start()
    {
        ...
        var p = Vector3.Lerp(startPos,endPos,(float)(logPos + 9) / 27);
    ...
    {
        const string logTag = "[LogScript::GameUpdate]";
    ...
    {
        StartCoroutine("LogReset");
        gameObject.SetActive(true);

    }

    [Obsolete("...")]
    IEnumerator LogReset()
    {
